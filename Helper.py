...
class Helper(object):
    def __init__(self):
        ...
        self.character = pygame.image.load("assets/spaceship.png")
        self.ast = pygame.image.load("assets/asteroid.png")
        self.black_heart = pygame.image.load("assets/black_heart.png")
        self.red_heart = pygame.image.load("assets/red_heart.png")
    ...
    def main_menu(self):
        while True:
            ...
            self.window.blit(self.background, (-500,-10))
            self.window.blit(mainText, (300, 100))
            mx, my = pygame.mouse.get_pos()
            startButton = pygame.Rect(475, 275, 200, 75)
            exitButton = pygame.Rect(515, 425, 130, 75)
            ...
            self.window.blit(exitText,(525, 420))
